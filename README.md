...
## Overview  
This project is a **Twitter Sentiment Analysis** web application built using **Streamlit** and **Scikit-learn**.  
The application takes a tweet as input and predicts its sentiment as **Positive** or **Negative** using a trained **Logistic Regression** model.
...
## Live Demo  
https://twitter-sentiment-analysis-vnbby5nttxr8jxwsqhp5cf.streamlit.app/
